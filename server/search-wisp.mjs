...
Object.assign(wisp.options,{dns_result_order:"ipv4first",allow_udp_streams:false,allow_private_ips:false,allow_loopback_ips:false,allow_direct_ip:false,port_whitelist:[80,443],stream_limit_per_host:32,stream_limit_total:128});
